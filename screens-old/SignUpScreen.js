    ...
    return (
        <View style={[styles.signUp, styles.signUpLayout]}>
            <View style={styles.background}>
                ...
                <Text
                    style={[
                        styles.greeting,
                        styles.tabsPosition,
                        styles.greetingFlexBox,
                    ]}
                >
                    <Text style={styles.generalFont}>Howdy </Text>
                    <Text style={[styles.rookies, styles.generalFont]}>
                        rookies,
                    </Text>
                </Text>
            </View>
            <View style={styles.buttons}>
                ...
                >
                    <Text
                        style={[styles.submitButtonFont, styles.textInputTypo]}
                    >
                        Sign up
                    </Text>
                    <Image
                ...
                <Image
                    style={[
                        styles.appleButtonIconPosition,
                        styles.socialButtonLayout,
                    ]}
                    resizeMode='cover'
            ...
            >
                <Text style={[styles.loginTabPosition, styles.TabTypo]}>
                    Login
                </Text>
                <Text style={[styles.signUpTabPosition, styles.TabTypo]}>
                    Sign up
                </Text>
            ...
            <View style={styles.inputs}>
                <View
                    style={[
                        styles.emailInputPositionPosition,
                ...
                <View
                    style={[
                        styles.confirmPasswordPosition,
                        styles.passwordLayout,
                    ]}
                >
                    <TextInput
