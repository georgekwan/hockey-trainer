  ...
  return (
    <View style={[styles.signUp, styles.signUpLayout]}>
      <View style={styles.background}>
        ...
        <Text style={[styles.greeting, styles.tabsPosition, styles.greetingFlexBox]}>
          <Text style={styles.generalFont}>Howdy </Text>
          <Text style={[styles.rookies, styles.generalFont]}>rookies,</Text>
        </Text>
      </View>
      <View style={styles.buttons}>
        <Pressable style={[styles.submitButton, styles.selectionBg]} onPress={signUpHandler}>
          <Text style={[styles.submitButtonFont, styles.textInputTypo]}>Sign up</Text>
          <Image
      ...
      <View style={styles.inputs}>
        <View style={[styles.emailInputPositionPosition, styles.passwordLayout]}>
          <TextInput
            placeholder="Email"
