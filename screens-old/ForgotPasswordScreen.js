  ...
  return (
    <View style={styles.forgotPassword}>
      ...
      <View style={styles.text}>
        <Text style={[styles.forgotPassword1, styles.placeholderFlexBox]}>Forgot Password?</Text>
        <Text style={[styles.enterYourInformationsBelow, styles.tryAnotherWayLayout]}>
          <Text style={styles.enterYourInformations}>Enter your email below</Text>
      ...
      <Pressable style={styles.circleLeft} onPress={() => navigation.navigate('signInScreen')}>
        <Image
          style={styles.icon}
          resizeMode="cover"
